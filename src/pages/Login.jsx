      ...
      <section class="h-screen flex items-stretch text-white ">
        <div class="lg:flex w-1/2 hidden bg-gray-500 bg-no-repeat bg-cover relative items-center loginBg">
          ...
          <div class="w-full px-24 z-10">
            <h1 class="text-5xl text-[#4baf47] font-bold text-left tracking-wide">
              EcoDiscova
            </h1>
        ...
        <div class="lg:w-1/2 w-full  flex items-center justify-center text-center md:px-16 px-0 z-0 loginBgColor ">
          ...
          <div class="w-full py-0 z-20">
            ...
            >
              ...
              <div class="  flex loginInput w-full  rounded-sm border-0 focus:border-4 border-white">
                {/* block w-full p-4 text-lg rounded-sm loginInput */}
                <input
                  className="bg-transparent py-4 px-4 w-[100%] lg:p-4 focus:border-0 focus:outline-none"
                ...
                <button
                  ...
                  className="flex items-center mr-4 px-3 text-xl "
                  id="visible"
                >
                  {passwordVisible ? (
              ...
              <div class="text-right text-gray-400 hover:underline hover:text-gray-100 my-4">
                <a href="#">Forgot your password?</a>
              </div>
              <h2 className="mt-6 lg:mt-4">
              ...
              {/* <div class="p-4 text-center right-0 left-0  justify-center space-x-4 mt-16 hidden lg:block ">
